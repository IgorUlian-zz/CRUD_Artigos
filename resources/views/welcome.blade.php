        ...
        <body class="antialiased font-sans">
            ...
            <div class="relative isolate px-6 pt-14 lg:px-8">
                ...
                <div class="text-center">
                    <h1 class="text-5xl font-semibold tracking-tight text-balance text-white sm:text-7xl">Bem vindo a sua página de artigos.</h1>
                    <p class="mt-8 text-lg font-medium text-pretty text-gray-400 sm:text-xl/8">Nesse vasto mundo de técnologia encontramos aqui os melhores artigos para seu desenvolvimento pessoal.</p>
                    <div class="mt-10 flex items-center justify-center gap-x-6">
                    <a href="http://project_lt_cloud_laravel.test/register" class="rounded-md bg-indigo-500 px-3.5 py-2.5 text-sm font-semibold text-white shadow-xs hover:bg-indigo-400 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-500">Vamos lá ?</a>
                    </div>
                </div>
                </div>
